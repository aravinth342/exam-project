...
<head>
    ...
    <title>Manage Departments - Exam Hall Arrangement System</title>
...
<body>
    <div class="container">
        <header>
            <div class="header-content">
                ...
                <div class="college-info">
                    ...
                    <h2>Exam Hall Arrangement System - Manage Departments</h2>
                </div>
            </div>
        </header>
        ...
        <main>
            ...
            <h3><?php echo $edit_dept ? 'Edit' : 'Add'; ?> Department</h3>
            <form method="post">
                <?php if ($edit_dept): ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo $edit_dept ? $edit_dept['name'] : ''; ?>" required>
                </div>
                <button type="submit" name="<?php echo $edit_dept ? 'edit' : 'add'; ?>"><?php echo $edit_dept ? 'Update' : 'Add'; ?> Department</button>
                <?php if ($edit_dept): ?>
                ...
                <tbody>
                    <?php foreach ($departments as $dept): ?>
                        <tr>
                            ...
                            <td>
                                <a href="?edit=<?php echo $dept['id']; ?>" class="btn">Edit</a>
